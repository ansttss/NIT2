!function (t) {
    ...
    function i() {
        document.getElementById("cartPopup").style.left = "-500px", document.getElementById("wrap").style.marginLeft = "0", document.getElementById("body").style.overflowX = "visible", document.getElementById("curtain").style.display = "none"
    }
    ...
    jQuery.ajax({
        ...
        document.getElementById("cartPopup").style.left = "0px", document.getElementById("wrap").style.marginLeft = "500px", document.getElementById("body").style.overflowX = "hidden", document.getElementById("curtain").style.display = "inline"
